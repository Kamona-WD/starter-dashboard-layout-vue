  ...
  <AuthCard title="Login">
    <template #form>
      <form action="#" class="space-y-6">
        ...
        <div class="flex items-center justify-between">
          ...
          <a @click.prevent="() => {}" href="forgot-password.html" class="text-sm text-blue-600 hover:underline">
            Forgot Password?
          </a>
        </div>
        <div>
    ...
    <template #footer>
      ...
      <div class="text-sm text-gray-600">
        ...
        <router-link :to="{ name: 'Register' }" class="text-blue-600 hover:underline">Register</router-link>
      </div>
    </template>
  </AuthCard>
</template>
